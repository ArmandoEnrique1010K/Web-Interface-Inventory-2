...
export async function registerCategory(formData: CategoryForm): Promise<string> {
    try {
...
export async function getCategory(id: number): Promise<CategoryItem> {
    try {
...
export async function updateCategory({ categoryId, formData }: UpdateCategoryPayload): Promise<string> {
    try {
