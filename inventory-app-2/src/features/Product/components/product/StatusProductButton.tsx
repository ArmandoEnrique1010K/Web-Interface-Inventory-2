    ...
    return (
        <>
            ...
            {isActive && confirmationModal && (
                ...
                >
                    <div className="pb-6">
                        Al desactivar un producto, también se van a desactivar
                        los modelos incluidos en el producto. Recuerda que para
                        activar un modelo debes activar el producto. ¿Desea
                        continuar?
                    </div>
